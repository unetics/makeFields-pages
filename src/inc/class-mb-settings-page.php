<?php
    ...
    class MB_Settings_Page {
        ...
        public function show() {
            ...
            <?php if ( $this->args['tabs'] ) : ?>
                <div class="nav-tab-wrapper">
                    <div class="title"><h2><?php echo esc_html( $this->args['page_title'] ); ?></h2></div>
        ...
        public function admin_print_styles() {
            ...
            wp_enqueue_style( 'mb-settings-page', $url . 'css/settings.css', '', '1.1.5' );
            ...
            wp_enqueue_script( 'mb-settings-page', $url . 'js/script.js', array( 'jquery' ), '1.1.5', true );
